  ...
  function addSourceSearch(spiderName, spiderUri) {
    ...
    var source = {
      ...
      onSelect: function(params, close) {
        ...
        var id = Lampa.Utils.hash(params.element.number_of_seasons ? params.element.original_name : params.element.original_title);
        ...
        Lampa.Activity.push({
          ...
          page: 1,
          search: all[id] ? all[id] : params.element.title,
          clarification: true,
