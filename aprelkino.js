...
window.rch_nws[hostkey].Registry = function RchRegistry(client, startConnection) {
      ...
      onSelect: function(params, close) {
        ...
        (function() {
          Lampa.Activity.push({
            ...
            title: 'Aprelkino - ' + params.element.title,
            component: 'aprelkino',
  ...
  var showyFreePluginVersion = '1.7.5';

  function startPlugin() {
    window.aprelkino_plugin = true;
    window.aprelkino_plugin_version = showyFreePluginVersion;
    var manifst = {
      type: 'video',
  ...
  if (!window.aprelkino_plugin || window.aprelkino_plugin_version != showyFreePluginVersion) startPlugin();
